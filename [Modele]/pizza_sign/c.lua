local model_id       = 1910 -- id modelu który chcesz podmienić (podaj liczbe)
...
local txd_name       = "pizza_sign.txd" -- nazwa pliku txd
--local col_name       = "wall.col" -- nazwa pliku col
local dff_name        = "pizza_sign.dff" -- nazwa pliku dff
