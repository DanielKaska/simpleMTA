local model_id       = 7520 -- id modelu który chcesz podmienić (podaj liczbe)
...
local col_name       = "mechanik.col" -- nazwa pliku col
local dff_name        = "mechanik.dff" -- nazwa pliku dff
