local model_id       = 1899 -- id modelu który chcesz podmienić (podaj liczbe)
...
local txd_name       = "brickgrey.txd" -- nazwa pliku txd
local col_name       = "sara.col" -- nazwa pliku col
local dff_name        = "sara.dff" -- nazwa pliku dff
